...
lat, lon = 37.05295, -8.2708
date_str = "2025-09-25"
buffer_m = 500

print("Finding scene for Tartaruga on 2025-09-25...")
...
temp_raw_path = "scratch_tartaruga_raw.png"
...
temp_enh_path = "scratch_tartaruga_enh.png"
...
for temp_path, out_name in [(temp_raw_path, "tartaruga_green_20250925_raw.png"), (temp_enh_path, "tartaruga_green_20250925_enhanced.png")]:
