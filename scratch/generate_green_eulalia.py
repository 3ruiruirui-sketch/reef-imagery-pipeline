...
print("Rendering 1200 DPI image with green colormap...")
...
temp_path = "scratch_green_1200dpi.png"
...
dst_path = "/Users/ssoares/.gemini/antigravity-ide/brain/d6246231-ba06-4562-9142-e672e792f965/pedra_santa_eulalia_green_20250925_compressed.png"
cv2.imwrite(dst_path, resized, [cv2.IMWRITE_PNG_COMPRESSION, 9])

if os.path.exists(temp_path):
    os.remove(temp_path)

print(f"✅ Success! Saved green colormap image: {dst_path} (size: {os.path.getsize(dst_path)/1e6:.2f} MB)")
