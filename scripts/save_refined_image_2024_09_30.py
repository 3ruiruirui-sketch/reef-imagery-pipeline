...
print("Saving images...")
plt.imsave(os.path.join(output_dir, "original_20240930.png"), orig_vis, cmap='gray')
plt.imsave(os.path.join(output_dir, "refined_20240930.png"), ref_vis, cmap='gray')
plt.imsave(os.path.join(output_dir, "refined_color_20240930.png"), ref_vis, cmap='viridis')
